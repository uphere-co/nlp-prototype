...
defYGP = ConfigYGP { engine_type             = "ygp"
                   ...
                   , word_uids_dump          = "all_words" -- "/data/groups/uphere/similarity_test/all_words"
                   ...
                   , word_prob_dump          = "prob.h5" -- "/data/groups/uphere/similarity_test/prob.h5"
                   ...
                   , w2v_float_t             = "float32"
                   , wikidata_entities       = "wikidata.all_entities" -- "/home/jihuni/word2vec/rss/wikidata.all_entities"
                   , wikidata_uids           = "wikidata.uid" -- "/home/jihuni/word2vec/rss/wikidata.uid"
                   , wikidata_properties     = "wikidata.properties" -- "/home/jihuni/word2vec/rss/wikidata.properties"
                   , named_entity_uids       = "wikidata.uid.ne" -- "/home/jihuni/word2vec/rss/wikidata.uid.ne"
                   }
