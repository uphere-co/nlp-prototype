...
#ifndef FLATBUFFERS_GENERATED_PAIRS_UTIL_IO_H_
#define FLATBUFFERS_GENERATED_PAIRS_UTIL_IO_H_
...
inline flatbuffers::Offset<Pairs> CreatePairsDirect(
  ...
  return util::io::CreatePairs(
      _fbb,
      vals ? _fbb.CreateVector<const Pair *>(*vals) : 0);
}

inline const util::io::Pairs *GetPairs(const void *buf) {
  return flatbuffers::GetRoot<util::io::Pairs>(buf);
}
...
inline bool VerifyPairsBuffer(
  ...
  return verifier.VerifyBuffer<util::io::Pairs>(PairsIdentifier());
}
...
inline void FinishPairsBuffer(
    ...
    flatbuffers::Offset<util::io::Pairs> root) {
...
#endif  // FLATBUFFERS_GENERATED_PAIRS_UTIL_IO_H_
