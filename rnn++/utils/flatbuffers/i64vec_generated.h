...
#ifndef FLATBUFFERS_GENERATED_I64VEC_UTIL_IO_FB_H_
#define FLATBUFFERS_GENERATED_I64VEC_UTIL_IO_FB_H_
...
inline flatbuffers::Offset<I64Vector> CreateI64VectorDirect(
  ...
  return util::io::fb::CreateI64Vector(
      _fbb,
      vals ? _fbb.CreateVector<int64_t>(*vals) : 0);
}

inline const util::io::fb::I64Vector *GetI64Vector(const void *buf) {
  return flatbuffers::GetRoot<util::io::fb::I64Vector>(buf);
}
...
inline bool VerifyI64VectorBuffer(
  ...
  return verifier.VerifyBuffer<util::io::fb::I64Vector>(I64VectorIdentifier());
}
...
inline void FinishI64VectorBuffer(
    ...
    flatbuffers::Offset<util::io::fb::I64Vector> root) {
...
#endif  // FLATBUFFERS_GENERATED_I64VEC_UTIL_IO_FB_H_
