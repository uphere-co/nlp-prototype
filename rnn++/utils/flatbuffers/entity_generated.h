...
#ifndef FLATBUFFERS_GENERATED_ENTITY_UTIL_IO_FB_H_
#define FLATBUFFERS_GENERATED_ENTITY_UTIL_IO_FB_H_
...
inline flatbuffers::Offset<Entities> CreateEntitiesDirect(
  ...
  return util::io::fb::CreateEntities(
      _fbb,
      entities ? _fbb.CreateVector<flatbuffers::Offset<Entity>>(*entities) : 0,
      names ? _fbb.CreateVector<int64_t>(*names) : 0);
}

inline const util::io::fb::Entities *GetEntities(const void *buf) {
  return flatbuffers::GetRoot<util::io::fb::Entities>(buf);
}
...
inline bool VerifyEntitiesBuffer(
  ...
  return verifier.VerifyBuffer<util::io::fb::Entities>(EntitiesIdentifier());
}
...
inline void FinishEntitiesBuffer(
    ...
    flatbuffers::Offset<util::io::fb::Entities> root) {
...
#endif  // FLATBUFFERS_GENERATED_ENTITY_UTIL_IO_FB_H_
